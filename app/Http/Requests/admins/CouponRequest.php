    ...
    public function rules(): array
{
    ...
    return [
        ...
        'coupon_amount' => ['required', 'numeric', function ($attribute, $value, $fail) {
            if ($this->discount_type == 0) {
                if ($value < 1 || $value > 30) {
                    return $fail('Giảm giá phần trăm phải trong khoảng từ 1% đến 30%');
                }
            } else {
                if ($value <= 0) {
                ...
                if ($value > 200000) {
                    return $fail('Giảm giá tối đa là 200.000 VNĐ');
                }
            }
        }],
    ...
    public function messages()
    {
        ...
        'maximum_spend.gte' => 'Giá trị giỏ hàng tối đa phải lớn hơn hoặc bằng giá trị giỏ hàng tối thiểu.', // Thông báo cho giỏ hàng tối đa

...
<!-- jsvectormap css -->
<link href="{{ env('VIEW_ADMIN') }}/libs/jsvectormap/css/jsvectormap.min.css" rel="stylesheet" type="text/css" />

<!--Swiper slider css-->
<link href="{{ env('VIEW_ADMIN') }}/libs/swiper/swiper-bundle.min.css" rel="stylesheet" type="text/css" />
...
<script src="{{ env('APP_URL') }}/jquery.js"></script>

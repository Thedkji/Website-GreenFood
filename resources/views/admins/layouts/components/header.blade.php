                ...
                <div class="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                    <div data-simplebar style="max-height: 320px;">
                        ...
                        <div class="notification-list">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item py-2">
                                <div class="d-flex">
                                    <img src="{{ env('VIEW_ADMIN') }}/images/users/avatar-5.jpg"
                                        class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                    <div class="flex-grow-1">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="dropdown ms-1 topbar-head-dropdown header-item">
                <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                    ...
                    <img id="header-lang-img" src="{{ env('VIEW_ADMIN') }}/images/flags/us.svg" alt="Header Language"
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item language py-2" data-lang="en"
                        title="English">
                        <img src="{{ env('VIEW_ADMIN') }}/images/flags/us.svg" alt="user-image" class="me-2 rounded"
                            height="18">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="sp"
                        title="Spanish">
                        <img src="{{ env('VIEW_ADMIN') }}/images/flags/spain.svg" alt="user-image"
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="gr"
                        title="German">
                        <img src="{{ env('VIEW_ADMIN') }}/images/flags/germany.svg" alt="user-image"
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="it"
                        title="Italian">
                        <img src="{{ env('VIEW_ADMIN') }}/images/flags/italy.svg" alt="user-image"
                            class="me-2 rounded" height="18">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ru"
                        title="Russian">
                        <img src="{{ env('VIEW_ADMIN') }}/images/flags/russia.svg" alt="user-image"
                            class="me-2 rounded" height="18">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ch"
                        title="Chinese">
                        <img src="{{ env('VIEW_ADMIN') }}/images/flags/china.svg" alt="user-image"
                            class="me-2 rounded" height="18">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="fr"
                        title="French">
                        <img src="{{ env('VIEW_ADMIN') }}/images/flags/french.svg" alt="user-image"
                            class="me-2 rounded" height="18">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ar"
                        title="Arabic">
                        <img src="{{ env('VIEW_ADMIN') }}/images/flags/ae.svg" alt="user-image" class="me-2 rounded"
                            height="18">
                ...
                <div class="dropdown-menu dropdown-menu-lg p-0 dropdown-menu-end">
                    ...
                    <div class="p-2">
                        <div class="row g-0">
                            <div class="col">
                                <a class="dropdown-icon-item" href="#!">
                                    <img src="{{ env('VIEW_ADMIN') }}/images/brands/github.png" alt="Github">
                                    <span>GitHub</span>
                                </a>
                            </div>
                            <div class="col">
                                <a class="dropdown-icon-item" href="#!">
                                    <img src="{{ env('VIEW_ADMIN') }}/images/brands/bitbucket.png" alt="bitbucket">
                                    <span>Bitbucket</span>
                                </a>
                            </div>
                            <div class="col">
                                <a class="dropdown-icon-item" href="#!">
                                    <img src="{{ env('VIEW_ADMIN') }}/images/brands/dribbble.png" alt="dribbble">
                                    <span>Dribbble</span>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="row g-0">
                            <div class="col">
                                <a class="dropdown-icon-item" href="#!">
                                    <img src="{{ env('VIEW_ADMIN') }}/images/brands/dropbox.png" alt="dropbox">
                                    <span>Dropbox</span>
                                </a>
                            </div>
                            <div class="col">
                                <a class="dropdown-icon-item" href="#!">
                                    <img src="{{ env('VIEW_ADMIN') }}/images/brands/mail_chimp.png" alt="mail_chimp">
                                    <span>Mail Chimp</span>
                                </a>
                            </div>
                            <div class="col">
                                <a class="dropdown-icon-item" href="#!">
                                    <img src="{{ env('VIEW_ADMIN') }}/images/brands/slack.png" alt="slack">
                                    <span>Slack</span>
                                </a>
                            </div>
                        </div>
                ...
                <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end p-0 dropdown-menu-cart"
                    ...
                    <div data-simplebar style="max-height: 300px;">
                        <div class="p-2">
                            ...
                            <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                <div class="d-flex align-items-center">
                                    <img src="{{ env('VIEW_ADMIN') }}/images/products/img-2.png"
                                        class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                    <div class="flex-grow-1">
                                        <h6 class="mt-0 mb-1 fs-14">
                            ...
                            <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                <div class="d-flex align-items-center">
                                    <img src="{{ env('VIEW_ADMIN') }}/images/products/img-3.png"
                                        class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                    <div class="flex-grow-1">
                                        <h6 class="mt-0 mb-1 fs-14">
                            ...
                            <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                <div class="d-flex align-items-center">
                                    <img src="{{ env('VIEW_ADMIN') }}/images/products/img-6.png"
                                        class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                    <div class="flex-grow-1">
                                        <h6 class="mt-0 mb-1 fs-14">
                            ...
                            <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                <div class="d-flex align-items-center">
                                    <img src="{{ env('VIEW_ADMIN') }}/images/products/img-5.png"
                                        class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                    <div class="flex-grow-1">
                                        <h6 class="mt-0 mb-1 fs-14">
                    ...
                    <div class="tab-content position-relative" id="notificationItemsTabContent">
                        <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab" role="tabpanel">
                            <div data-simplebar style="max-height: 300px;" class="pe-2">
                                ...
                                <div class="text-reset notification-item d-block dropdown-item position-relative">
                                    <div class="d-flex">
                                        <img src="{{ env('VIEW_ADMIN') }}/images/users/avatar-8.jpg"
                                            class="me-3 rounded-circle avatar-xs flex-shrink-0" alt="user-pic">
                                        <div class="flex-grow-1">
                                            <a href="#!" class="stretched-link">
                ...
                <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                    ...
                    <span class="d-flex align-items-center">
                        ...
                        <span class="text-start ms-xl-2">
                            ...
                            <span
                                class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">{{ auth()->user()->role === 0 ? 'Quản trị viên' : 'User' }}</span>
                        </span>
                    </span>
                </button>
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    {{-- <a class="dropdown-item" href="{{ route('admin.profiles.profileDetail') }}"><i

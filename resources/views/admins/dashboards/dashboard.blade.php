                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar-sm bg-light rounded p-1 me-2">
                                                            <img src="{{ env('VIEW_ADMIN') }}/images/products/img-4.png"
                                                                alt="" class="img-fluid d-block" />
                                                        </div>
                                                        <div>
                                                            <h5 class="fs-14 my-1"><a
                    ...
                    <div class="card-body p-0">
                        ...
                        <div data-simplebar style="max-height: 410px;" class="p-3 pt-0">
                            <div class="acitivity-timeline acitivity-main">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <div class="d-inline-flex gap-2 border border-dashed p-2 mb-2">
                                            <a href="apps-ecommerce-product-details.html" class="bg-light rounded p-1">
                                                <img src="{{ env('VIEW_ADMIN') }}/images/products/img-8.png"
                                                    alt="" class="img-fluid d-block" />
                                            </a>
                                            <a href="apps-ecommerce-product-details.html" class="bg-light rounded p-1">
                                                <img src="{{ env('VIEW_ADMIN') }}/images/products/img-2.png"
                                            ...
                                            <a href="apps-ecommerce-product-details.html" class="bg-light rounded p-1">
                                                <img src="{{ env('VIEW_ADMIN') }}/images/products/img-10.png"
                                                    alt="" class="img-fluid d-block" />
                                            </a>
                                        </div>
                                ...
                                <div class="acitivity-item py-3 d-flex">
                                    <div class="flex-shrink-0">
                                        <img src="{{ env('VIEW_ADMIN') }}/images/users/avatar-2.jpg" alt=""
                                ...
                                <div class="acitivity-item d-flex">
                                    <div class="flex-shrink-0">
                                        <img src="{{ env('VIEW_ADMIN') }}/images/users/avatar-3.jpg" alt=""
                                            class="avatar-xs rounded-circle acitivity-avatar" />
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                        ...
                        <div class="card sidebar-alert bg-light border-0 text-center mx-4 mb-0 mt-3">
                            <div class="card-body">
                                <img src="{{ env('VIEW_ADMIN') }}/images/giftbox.png" alt="">
                                <div class="mt-4">

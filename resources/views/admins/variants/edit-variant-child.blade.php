...
@endif
<form class="needs-validation" method="post" novalidate action="{{route('admin.variants.update_child_variant', ['id' => $variant_detail->id])}}">
    @csrf
    @method('POST')
    <div class="row">
        <div class="col-lg-8">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="value" id="validationCustom01" value="{{$variant_detail->value}}" required>

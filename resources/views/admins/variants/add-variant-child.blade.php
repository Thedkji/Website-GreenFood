...
@section('title', 'Variant | Thêm mới chi tiết biến thể')

@section('start-page-title', 'Thêm mới chi tiết biến thể')

@section('link')
    <li class="breadcrumb-item"><a href="{{ route('admin.variants.add_child_variant') }}">Chi tiết biến thể</a></li>
    <li class="breadcrumb-item active">Thêm mới chi tiết biến thể</li>
@endsection
...
@section('content')
    ...
    <form class="needs-validation" method="post" action="{{ route('admin.variants.create_child_variant') }}" novalidate>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="mb-3">
                    <label for="validationCustom01" class="form-label">Giá trị của biến thể (VD: 5kg)</label>
                ...
                <div class="mb-3">
                    <label for="validationCustom01" class="form-label">Giá của biến thể</label>

...
<form action="{{ route('admin.comments.comment') }}" id="search-form" method="GET" class="row mb-3 d-flex flex-row-reverse">
    <div class="col-sm">
    ...
    <table class="table table-striped table-hover align-middle mb-0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('client.product-detail', $comment->product->id) }}">{{ $comment->product->name ?? 'No Product' }}</a>
                </td>
...
<div class="row my-3">
    <div class="col-sm">
        <button type="button" class="btn btn-danger" id="delete-button" style="display: none;" onclick="deleteSelected()">Xóa</button>
    </div>
</div>

            ...
            <div class="col-lg-8 col-xl-9">
                <div class="row g-4">
                    ...
                    <div class="col-lg-6">
                        ...
                        <a href="#" class="btn border border-success rounded-pill px-4 py-2 mb-4 text-primary"><i
                ...
                <div class="row g-4 fruite">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="d-flex justify-content-center my-4">
                            <a href="#"
                                class="btn border border-success px-4 py-3 rounded-pill text-primary w-100">Vew
                                More</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="border border-primary rounded position-relative vesitable-item">
                    ...
                    <div class="p-4 pb-0 rounded-bottom">
                        ...
                        <div class="d-flex justify-content-between flex-lg-wrap">
                            ...
                            <a href="#"
                                class="btn border border-success rounded-pill px-3 py-1 mb-4 text-primary"><i
                                    class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart</a>
                        </div>
                    </div>
                </div>

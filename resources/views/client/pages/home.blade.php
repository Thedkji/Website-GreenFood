                ...
                <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active rounded">
                            <img src="{{asset('img/hero-img-1.png')}}" class="img-fluid w-100 h-100 bg-success rounded"
                                alt="First slide">
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="row g-4">
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="rounded position-relative fruite-item">
                                        <div class="fruite-img">
                                            <img src="{{asset('img/fruite-item-2.jpg')}}" class="img-fluid w-100 rounded-top"
                                                alt="">
                                        </div>
                                        <div class="text-white bg-success px-3 py-1 rounded position-absolute"
                                            style="top: 10px; left: 10px;">Fruits</div>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="rounded position-relative fruite-item">
                                        <div class="fruite-img">
                                            <img src="{{asset('img/fruite-item-4.jpg')}}" class="img-fluid w-100 rounded-top"
                                                alt="">
                                        </div>
                                        <div class="text-white bg-success px-3 py-1 rounded position-absolute"
                                            style="top: 10px; left: 10px;">Fruits</div>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="rounded position-relative fruite-item">
                                        <div class="fruite-img">
                                            <img src="{{asset('img/fruite-item-3.jpg')}}" class="img-fluid w-100 rounded-top"
                                                alt="">
                                        </div>
                                        <div class="text-white bg-success px-3 py-1 rounded position-absolute"
                                            style="top: 10px; left: 10px;">Fruits</div>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="rounded position-relative fruite-item">
                                        <div class="fruite-img">
                                            <img src="{{asset('img/fruite-item-1.jpg')}}" class="img-fluid w-100 rounded-top"
                                                alt="">
                                        </div>
                                        <div class="text-white bg-success px-3 py-1 rounded position-absolute"
                                            style="top: 10px; left: 10px;">Fruits</div>
                        ...
                        <div class="col-lg-12">
                            <div class="row g-4">
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="rounded position-relative fruite-item">
                                        <div class="fruite-img">
                                            <img src="{{asset('img/fruite-item-6.jpg')}}" class="img-fluid w-100 rounded-top"
                                                alt="">
                                        </div>
                                        <div class="text-white bg-success px-3 py-1 rounded position-absolute"
                                            style="top: 10px; left: 10px;">Fruits</div>
        ...
        <div class="owl-carousel vegetable-carousel justify-content-center">
            <div class="border border-primary rounded position-relative vesitable-item">
                ...
                <div class="p-4 rounded-bottom">
                    ...
                    <div class="d-flex justify-content-between flex-lg-wrap">
                        <p class="text-dark fs-5 fw-bold mb-0">$4.99 / kg</p>
                        <a href="#" class="btn border border-success rounded-pill px-3 text-primary"><i
        ...
        <div class="row g-4 align-items-center">
            <div class="col-lg-6">
                <div class="py-4">
                    ...
                    <a href="#"
                        class="banner-btn btn btn-primary border-white border-success rounded-pill text-white py-3 px-5">BUY</a>
                </div>
            </div>
            <div class="col-lg-6">
    ...
    <div class="container py-5 fruite">
        ...
        <div class="row g-4 ">
            <div class="col-lg-6 col-xl-4">
                <div class="p-4 rounded border border-success fruite-item">
                    <div class="row align-items-center ">
                        <div class="col-6 fruite-img rounded-circle">
                            <img src="{{asset('img/best-product-1.jp')}}g" class="img-fluid rounded-circle w-100" alt="">
                        </div>
                        <div class="col-6">
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="p-4 rounded border border-success fruite-item">
                    <div class="row align-items-center ">
                        <div class="col-6 fruite-img rounded-circle">
                            <img src="{{asset('img/best-product-2.jp')}}g" class="img-fluid rounded-circle w-100" alt="">
                        </div>
                        <div class="col-6">
                            <a href="#" class="h5">Organic Tomato</a>
                            <div class="d-flex my-3">
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="p-4 rounded border border-success fruite-item">
                    <div class="row align-items-center ">
                        <div class="col-6 fruite-img rounded-circle">
                            <img src="{{asset('img/best-product-3.jp')}}g" class="img-fluid rounded-circle w-100" alt="">
                        </div>
                        <div class="col-6">
                            <a href="#" class="h5">Organic Tomato</a>
                            <div class="d-flex my-3">
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="p-4 rounded border border-success fruite-item">
                    <div class="row align-items-center ">
                        <div class="col-6 fruite-img rounded-circle">
                            <img src="{{asset('img/best-product-4.jp')}}g" class="img-fluid rounded-circle w-100" alt="">
                        </div>
                        <div class="col-6">
                            <a href="#" class="h5">Organic Tomato</a>
                            <div class="d-flex my-3">
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="p-4 rounded border border-success fruite-item">
                    <div class="row align-items-center ">
                        <div class="col-6 fruite-img rounded-circle">
                            <img src="{{asset('img/best-product-5.jp')}}g" class="img-fluid rounded-circle w-100" alt="">
                        </div>
                        <div class="col-6">
                            <a href="#" class="h5">Organic Tomato</a>
                            <div class="d-flex my-3">
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="p-4 rounded border border-success fruite-item">
                    <div class="row align-items-center ">
                        <div class="col-6 fruite-img rounded-circle">
                            <img src="{{asset('img/best-product-6.jp')}}g" class="img-fluid rounded-circle w-100" alt="">
                        </div>
                        <div class="col-6">
                            <a href="#" class="h5">Organic Tomato</a>
                            <div class="d-flex my-3">

        ...
        <div class="container-fluid contact py-5">
            <div class="container py-3  w-75">
                ...
                <form action="" class="row bg-light p-3 rounded gap-3">
                    ...
                    <div class="col-md-6 row justify-content-between align-items-center w-100">
                        ...
                        <div class="col-md-9">
                            <input type="text" placeholder="Nhập tuổi" class="form-control p-2">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 row justify-content-between align-items-center w-100">
                        ...
                        <div class="col-md-9">
                            <select name="options" id="" class="form-select p-2">
                    ...
                    <div class="col-md-6 row justify-content-between align-items-center w-100">
                        ...
                        <div class="col-md-9 w-100 text-end  ">
                            <button class="w-25 btn  border-secondary py-2 bg-white text-primary " type="submit">Thực hiện
                                tính</button>
                        </div>
                    </div>
            </div>
            ...
            <div class="container text-center py-2 mb-3">
                <img src="https://cellphones.com.vn/sforum/wp-content/uploads/2024/02/avatar-anh-meo-cute-5.jpg"
                    width="250" class="" alt="Mô tả hình ảnh" />
            </div>

...
<style>
    ...
    .fruite-img img {
        ...
        height: 150px;
        /* Adjust height to your desired value */
        object-fit: cover;
    ...
    .product-info {
        ...
        padding: 15px;
        /* Padding to add space around content */
        height: 100%;
        /* Ensure content fills the remaining height */
    }
    ...
    @media (max-width: 768px) {
        ...
        .vesitable-item {
            height: 400px;
            /* Smaller height for product items on mobile */
        }
                    ...
                    @php
                        ...
                        if ($product->status == 0) {
                            ...
                            if ($product->price_sale) {
                                $salePercent = round(
                                    (($product->price_regular - $product->price_sale) / $product->price_regular) * 100,
                                );
                            }
                            ...
                            if ($variantGroup && $variantGroup->price_sale) {
                                $salePercent = round(
                                    (($variantGroup->price_regular - $variantGroup->price_sale) /
                                        $variantGroup->price_regular) *
                                        100,
                                );
                            }
                        }

        ...
        <div class="pb-4 mb-4" style="border-bottom: 1px solid rgba(226, 175, 24, 0.5) ;">
            <div class="row g-4">
                <div class="col-lg-3">
                    ...
                    <p class="text-secondary mb-0">Sản phẩm heathyl</p>
                    </a>
                </div>
                <div class="col-lg-6">
        ...
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                <div class="footer-item">
                    ...
                    <p class="mb-4">Bởi vì chung tôi luôn chao đến tay khách hàng những sản phẩm chất lượng nhất.Mang lại cho khách những trảỉ nghiệm tối nhất khi mua hang ở GreenFood
                    </p>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="d-flex flex-column text-start footer-item">
                    ...
                    <a class="btn-link" href="{{ route('client.cart') }}">Giỏi hàng</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                <span class="text-light"><a href="#"><i class="fas fa-copyright text-light me-2"></i></a>GreenFood,TNHH Seven Seven Members</span>
            </div>
